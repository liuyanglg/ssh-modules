...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/public/css/bootstrap.min.css">
    <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/public/css/animate.css">
    <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/public/css/style.css">
</head>
<body>
...
<script src="<%=request.getContextPath()%>/resources/public/js/jquery-3.2.1.min.js"></script>
<script src="<%=request.getContextPath()%>/resources/public/js/bootstrap.min.js"></script>
<script src="<%=request.getContextPath()%>/resources/public/js/jquery.placeholder.min.js"></script>
<script src="<%=request.getContextPath()%>/resources/public/js/jquery.waypoints.min.js"></script>
